...
export const SPECIALS = [
  ...
  },
  {
    ...
    description: 'Through the Round of 16 (96 matches, incl. extra time) — over or under 248.5 goals? Resolves before the quarterfinals kick off.',
    emoji: '🌡️',
    options: [
      { value: 'over', label: 'Over 248.5' },
      { value: 'under', label: 'Under 248.5' },
    ],
    optionType: 'side',
    multiPick: false,
    resolvesTs: '2026-07-09T19:30:00Z',
  ...
  },
  {
    ...
    title: 'KO Cup Winner',
    description: 'Pick the World Cup winner from the remaining knockout teams. Separate pool from the group-stage cup winner bet.',
    emoji: '🏆',
    options: [],
    optionType: 'team',
    multiPick: false,

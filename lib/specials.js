...
export const SPECIALS = [
  ...
  },
  {
    ...
    optionType: 'team',
    multiPick: false,
    resolvesTs: '2026-07-15T23:00:00Z',
    formatPick: (pick) => {
      if (!pick) return pick;
  ...
  },
  {
    ...
    description: 'Will the whole tournament (all 104 matches, incl. extra time) produce over or under 269.5 goals?',
    emoji: '🌡️',
    options: [
      { value: 'over', label: 'Over 269.5' },
      { value: 'under', label: 'Under 269.5' },
    ],
    optionType: 'side',
    multiPick: false,
    resolvesTs: '2026-07-19T23:00:00Z',
